...
//			console.log(this);
	...
	var oBoX = document.getElementById(this.boxId);
		...
		ulObj.style.cssText = "width: 9999px;height: 310px; position: absolute;top: 0;left: 0;";
	...
	UlObj.style.cssText = "position: absolute;bottom: 0;width:267px;right: 500px;"
		for (var i = 0; i < this.imgs.length-1; i++) {
			var liObj = document.createElement("li");
				liObj.innerHTML=i+1;
			liObj.style.cssText = "float: left;width: 20px;height:20px;border-radius: 50%;margin-left: 10px;border:1px solid #424242;text-align: center;line-height: 20px;";
			liObj.ord = i;
			var that = this;		
...
player.prototype.left=function(){
		...
		var ulImgObj = boxObj.getElementsByTagName("ul")[0];
			A1left.innerHTML="&lt;";
			A1left.id="A1";
			A1left.style.cssText = "position: absolute;width: "+this.a1width+"px;height: "+this.a1height+"px;text-align: center;color: #757575;font-size: "+this.fontZisi+"px;left: 0px;top: "+this.a1top+"%;line-height: "+this.height+"px;";
 ...
 player.prototype.right=function(){
		...
		var ulImgObj = boxObj2.getElementsByTagName("ul")[0];
			A2left.innerHTML="&gt;";
			A2left.style.cssText = "position: absolute;width: "+this.a1width+"px;height: "+this.a1height+"px;text-align: center;color: #757575;font-size: "+this.fontZisi+"px;right: 0;top: "+this.a1top+"%;line-height: "+this.height+"px;";
	...
	window.onload = function() {
		var l = new player(
			...
			1350,
			360, 
			["img/lun1.jpg","img/lun2.jpg","img/lun3.jpg","img/lun4.jpg","img/lun5.jpg","img/lun6.jpg"],
			3000,
			{
				width: 20,
				height: 20,
